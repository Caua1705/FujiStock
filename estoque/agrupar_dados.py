...
def produtos_baixo_estoque(df_estoque):
    ...
    produtos_estoque_baixo=produtos_estoque_baixo.sort_values(by="Quantidade",)
...
def custo_total_por_categoria(df_estoque):
    ...
    df_estoque_por_categoria=df_estoque.groupby("Categoria")["Custo Total"].sum().reset_index().sort_values(by="Custo Total",ascending=False)
